      ...
      <div className="wrapper _loaded">
            ...
            <div className="header__menu menu">
              ...
              <nav className="menu__body _active">
                <ul className="menu__list">
                  <li><a href="" className="menu__link _active">Works</a></li>
        ...
        <footer className="footer">
          <div className="footer__content __container">
            <div className="footer__social social"><a href="" className="social__item _icon-fb"><svg width="30" height="30"
                  ...
                  <path
                    ...
                    fill="#21243D" />
                </svg> </a><a href="" className="social__item _icon-insta"><svg width="30" height="30" viewBox="0 0 30 30"
                  ...
                  <path
                    ...
                    fill="#21243D" />
                </svg> </a><a href="" className="social__item _icon-twitter"><svg width="37" height="30" viewBox="0 0 37 30"
                  fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="#21243D" />
                </svg> </a><a href="" className="social__item _icon-linkedin"><svg width="30" height="30" viewBox="0 0 30 30"
                  fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
